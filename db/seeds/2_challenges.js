    ...
    .then(function () {
      ...
      return knex('challenges').insert([
        ...
        },
        {
          ...
          challenge:"No  Added Sugar Challenge",
        ...
        },
        {
          ...
          challenge:"Complete a Galvanize Capstone Project in 10 Days",
        ...
        },
        {
          ...
          challenge:"How to Write a Sci Fi Story in 10 days",
        ...
        },
        {
          ...
          challenge:"Binge Watch Pokemon for Ten Days Straight",
